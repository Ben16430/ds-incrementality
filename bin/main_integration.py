...
def execute(cfg, **extra):
    """
    Integration process of the project to allow creation of predefined
    formats for output files that will be consumption by external systems,
    such as the EDW.
